...
#define tmpoffsetof(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)
/**
...
//        (type *)( (char *)__mptr - tmpoffsetof(type,member) );})
*/
#define container_of(ptr, type, member) (type *)((char *)ptr - tmpoffsetof(type,member))
