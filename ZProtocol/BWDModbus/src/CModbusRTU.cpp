...
void  CModbusRTU::ProcessMemoryUInt16(ST_BYTE* buf, const ST_DataAreaItem& itemref)
{
	...
	else if(itemref.dataLen == 2)
	{
		...
		else if((itemref.codeType == 1))
		{
                                                ...
                                                if(value == 0x0070)
                                                {
                                                                bvalue = (0x01>>(itemref.beginBit - 1))&0x01;
                                                                this->UpdateValue(itemref.id, bvalue);
                                                }
                                                 else if(value == 0x0060)
                                                {
                                                                bvalue = (0x02>>(itemref.beginBit - 1))&0x01;
                                                                 this->UpdateValue(itemref.id, bvalue);
                                                }
                                                 else if(value == 0x0080)
                                                {
                                                                bvalue = (0x04>>(itemref.beginBit - 1))&0x01;
                                                                 this->UpdateValue(itemref.id, bvalue);
                                                }
                                                 else if(value == 0x0050)
                                                {
                                                                bvalue = (0x08>>(itemref.beginBit - 1))&0x01;
                                                                 this->UpdateValue(itemref.id, bvalue);
                                                }
                                                else if(itemref.id>=0&&itemref.id<=3)
                                                {
