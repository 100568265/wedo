...
bool CDL645::OnSend()
{
	...
	switch(m_readIndex) {
        ...
        case 29: ReadData(0x00020100); break; //反向有功電能尖
        case 30: ReadData(0x00020200); break; //反向有功電能鋒
        case 31: ReadData(0x00020300); break; //反向有功電能平
        case 32: ReadData(0x00020400); break; //反相有功电能谷
 		default: break;
	}
