...
void	CKB307::OnRead(ST_BYTE* pbuf,ST_INT& readed)
{
	readed = 0;
	if(! this->GetCurPort())
		return;
...
ST_BOOLEAN	CKB307::OnProcess(ST_BYTE* pbuf,ST_INT len)
{
...
ST_BOOLEAN	CKB307::IsSupportEngine(ST_INT engineType)
{
    return 1;
}
