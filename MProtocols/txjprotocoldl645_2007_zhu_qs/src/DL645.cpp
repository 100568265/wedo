...
*/
        case 6:  ReadData (0x00000000); // (当前)组合有功总电能
            break;
		case 7:  ReadData (0x00000100); // (当前)组合有功费率1电能
            break;
        case 8:  ReadData (0x00000200); // (当前)组合有功费率2电能
            break;
        case 9:  ReadData (0x00000300); // (当前)组合有功费率3电能
            break;
        case 10:  ReadData (0x00000400); // (当前)组合有功费率4电能
            break;

        case 11:  ReadData (0x00010000); // (当前)正向有功总电能
            break;
		case 12:  ReadData (0x00010100); // (当前)正向有功费率1电能
            break;
        ...
        case 16:  ReadData (0x00020000); // (当前)反向有功总电能
            break;
		case 17:  ReadData (0x00020100); // (当前)反向有功费率1电能
            break;
        case 18:  ReadData (0x00020200); // (当前)反向有功费率2电能
            break;
        case 19:  ReadData (0x00020300); // (当前)反向有功费率3电能
            break;
        case 20:  ReadData (0x00020400); // (当前)反向有功费率4电能
            break;


        case 21:  ReadData (0x00030000); // (当前)组合无功1总电能
            break;
		case 22:  ReadData (0x00030100); // (当前)组合无功1费率1电能
            break;
        case 23:  ReadData (0x00030200); // (当前)组合无功1费率2电能
            break;
        case 24:  ReadData (0x00030300); // (当前)组合无功1费率3电能
            break;
        case 25:  ReadData (0x00030400); // (当前)组合无功1费率4电能
            break;


        case 26:  ReadData (0x00040000); // (当前)组合无功2总电能
            break;
		case 27:  ReadData (0x00040100); // (当前)组合无功2费率1电能
            break;
        case 28:  ReadData (0x00040200); // (当前)组合无功2费率2电能
            break;
        case 29:  ReadData (0x00040300); // (当前)组合无功2费率3电能
            break;
        case 30:  ReadData (0x00040400); // (当前)组合无功2费率4电能
            break;
...
/*
        ...
        case 31:  ReadData (0x00010001); // (上1结算日)正向有功总电能
            break;
		case 32:  ReadData (0x00010101); // (上1结算日)正向有功费率1电能
            break;
        case 33:  ReadData (0x00010201); // (上1结算日)正向有功费率2电能
            break;
        case 34:  ReadData (0x00010301); // (上1结算日)正向有功费率3电能
            break;
        case 35:  ReadData (0x00010401); // (上1结算日)正向有功费率4电能
            break;



        case 36:  ReadData (0x01010000); // (当前)正向有功总最大需量
            break;
        case 37:  ReadData (0x01010001); // (上1结算日)正向有功总最大需量
            break;



        case 38:  ReadData (0x00830000); // 当前正向有功谐波总电能
            break;
        case 39:  ReadData (0x00840000); // 当前反向有功谐波总电能
            break;
