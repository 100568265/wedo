...
public:
	...
	clock_t		Newcurtime,oldcurtime,sendserchtime,OneTime,TwoTime;
	void	SendASDU21();
	void	SendASDU21(ST_BYTE readCode,ST_UINT16 GIN);
	void	SendASDU6();
...
private:
	...
	int     getfun16VarId(int inf);
	int     getfun17VarId(int inf);
